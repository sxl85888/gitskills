...
CREATE TABLE `yershop_account_log`  (
  ...
  `content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
CREATE TABLE `yershop_ad`  (
  ...
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `url` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接',
  `place` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '位置',
...
) ENGINE = MyISAM AUTO_INCREMENT = 17 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '广告表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_address`  (
  ...
  `orderid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `mobile` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `province` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `area` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `zipcode` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `status` tinyint(2) NOT NULL DEFAULT 0 COMMENT '数据状态',
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 61 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收件人地址表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_address
-- ----------------------------
INSERT INTO `yershop_address` VALUES (44, NULL, '5675', '浙江', '宁波市', '市辖区', '56756675', '56756', NULL, NULL, 1522532976, 0, 1);
INSERT INTO `yershop_address` VALUES (45, NULL, '56765', '上海', '上海市', '徐汇区', '5675675', '5675', NULL, NULL, 1522533018, 0, 1);
INSERT INTO `yershop_address` VALUES (46, NULL, '13444566888', '天津', '天津市', '汉沽区', 'dden&quot name=&quotid&quot value=&quot$info.id|default=&quot&quot&quot&gt', '787899', NULL, NULL, 1522541640, 0, 1);
INSERT INTO `yershop_address` VALUES (48, NULL, '1378978456', '山西', '太原市', '小店区', ' window.location.href =data.url', '1742204646@qq.com', NULL, NULL, 1522541750, 0, 1);
INSERT INTO `yershop_address` VALUES (49, NULL, '1378978453', '天津', '天津市', '河东区', ' window.location.href =data.url', '1742204646@qq.com', '1378978453', '', 1522541852, 1, 1);
INSERT INTO `yershop_address` VALUES (50, NULL, '1312255889', '内蒙古', '鄂尔多斯市', '鄂托克旗', '呃呃呃', '刘伟', NULL, NULL, 1522660101, 0, 31);
INSERT INTO `yershop_address` VALUES (51, NULL, '15324782937', '北京', '北京市', '西城区', 'xuehun', 'xuehun', '', NULL, 0, 0, 33);
INSERT INTO `yershop_address` VALUES (52, NULL, '15324782937', '北京', '北京市', '西城区', 'xuehun&lt/p&gt', 'xuehun&lt/p&gt', '', NULL, 0, 0, 33);
INSERT INTO `yershop_address` VALUES (53, NULL, '_445', '山西', '长治市', '襄垣县', '1222', '4123', NULL, NULL, 1522805858, 0, 34);
INSERT INTO `yershop_address` VALUES (54, NULL, '13870996403', '山东', '济南市', '历下区', '红谷新力中心', 'll', '', NULL, 0, 0, 37);
INSERT INTO `yershop_address` VALUES (55, NULL, '15222222222', '天津', '天津市', '和平区', ' 计划管理科', '2135', '', NULL, 0, 0, 39);
INSERT INTO `yershop_address` VALUES (56, NULL, '13547119500', '天津', '天津市', '河东区', '32331', '31312', '135471195001', NULL, 0, 0, 44);
INSERT INTO `yershop_address` VALUES (57, NULL, '15915641111', '山东', '德州市', '德城区', '大学东路9688号', '显示', '', NULL, 0, 0, 47);
INSERT INTO `yershop_address` VALUES (58, NULL, '13656563362', '天津', '天津市', '河东区', 'dffsfsd', 'test', '', NULL, 0, 0, 52);
INSERT INTO `yershop_address` VALUES (60, NULL, '66', '河北', '沧州市', '市辖区', '66', '66', NULL, NULL, 1524774486, 0, 2);
...
CREATE TABLE `yershop_area`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 820002 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '地址联动表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_attachment`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `exts` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type` smallint(2) NOT NULL DEFAULT 0,
  `size` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `oldname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 488 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
INSERT INTO `yershop_attachment` VALUES (444, '/public/uploads/picture/20180726/cb2b57ca5f20b07a110d800426682221.jpg', '', '', '', 1, 1532599368, 'jpg', 1, '54862', 'timg.jpg');
INSERT INTO `yershop_attachment` VALUES (445, '/public/uploads/picture/20180726/52a59e549ba281a060174c72205592e1.jpg', '', '', '', 1, 1532599534, 'jpg', 1, '17226', 'u=2904762882,3036116843&fm=27&gp=0.jpg');
INSERT INTO `yershop_attachment` VALUES (446, '/public/uploads/picture/20180727/6a6593d85191ce36f8d0fe677a847a73.png', '', '', '', 1, 1532673486, 'png', 1, '10739', 'QQ截图20180727143745.png');
INSERT INTO `yershop_attachment` VALUES (447, '/public/uploads/picture/20180727/bc16ad9b60b660cd85be9d961def2cc1.png', '', '', '', 1, 1532673533, 'png', 1, '10739', 'QQ截图20180727143745.png');
INSERT INTO `yershop_attachment` VALUES (448, '/public/uploads/picture/20180727/00aab0b9d2ba2de3ebbab019540eb896.png', '', '', '', 1, 1532674587, 'png', 1, '10377', 'logo_pic_1.png');
INSERT INTO `yershop_attachment` VALUES (449, '/public/uploads/picture/20180727/b386fc621cbebe6b9e30688decbde067.jpg', '', '', '', 1, 1532678062, 'jpg', 1, '25941', '牛肉卷.jpg');
INSERT INTO `yershop_attachment` VALUES (450, '/public/uploads/picture/20180727/9c6697af0dd1ef5322fdc1cc8dad64ab.jpg', '', '', '', 1, 1532678196, 'jpg', 1, '77203', '肉卷1.jpg');
INSERT INTO `yershop_attachment` VALUES (451, '/public/uploads/picture/20180727/ed2dad97c92bc529ee4e9e94fd8fa8b8.jpg', '', '', '', 1, 1532678202, 'jpg', 1, '108919', '肉卷2.jpg');
INSERT INTO `yershop_attachment` VALUES (452, '/public/uploads/picture/20180727/98932623f24f7cf13025b8b2c7d49dfe.jpg', '', '', '', 1, 1532678492, 'jpg', 1, '63150', '精瘦.jpg');
INSERT INTO `yershop_attachment` VALUES (453, '/public/uploads/picture/20180727/5dacb87f74b22359e9cf809e95197e0d.jpg', '', '', '', 1, 1532678567, 'jpg', 1, '55593', '精瘦1.jpg');
INSERT INTO `yershop_attachment` VALUES (454, '/public/uploads/picture/20180727/ab08bef3687d097d6a514f370c907be1.jpg', '', '', '', 1, 1532678639, 'jpg', 1, '50634', '精瘦2.jpg');
INSERT INTO `yershop_attachment` VALUES (455, '/public/uploads/picture/20180727/45393bf9fd9921bb6371f81ff39110c6.jpg', '', '', '', 1, 1532679035, 'jpg', 1, '59506', '腊.jpg');
INSERT INTO `yershop_attachment` VALUES (456, '/public/uploads/picture/20180727/15b9226946399ec93b80ba6f366ee2b1.jpg', '', '', '', 1, 1532679166, 'jpg', 1, '121658', '腊1.jpg');
INSERT INTO `yershop_attachment` VALUES (457, '/public/uploads/picture/20180727/ad929554eae78f3c22212c9ed2f4eceb.jpg', '', '', '', 1, 1532679174, 'jpg', 1, '121768', '腊2.jpg');
INSERT INTO `yershop_attachment` VALUES (458, '/public/uploads/picture/20180727/11516432f40a186d9b89e4e7390d94be.jpg', '', '', '', 1, 1532679520, 'jpg', 1, '27001', '牛肚.jpg');
INSERT INTO `yershop_attachment` VALUES (459, '/public/uploads/picture/20180727/13388c7ca810ded499f86cf1555986fb.jpg', '', '', '', 1, 1532679559, 'jpg', 1, '107759', '牛肚1.jpg');
INSERT INTO `yershop_attachment` VALUES (460, '/public/uploads/picture/20180727/eb61023d7eafb1c8e182809329e72f3a.jpg', '', '', '', 1, 1532679559, 'jpg', 1, '123362', '牛肚2.jpg');
INSERT INTO `yershop_attachment` VALUES (461, '/public/uploads/picture/20180727/9188beb0a4e93a2a417a467f990236ab.jpg', '', '', '', 1, 1532679714, 'jpg', 1, '40152', '腿.jpg');
INSERT INTO `yershop_attachment` VALUES (462, '/public/uploads/picture/20180727/a8a667b03a1b1541b0f8469a7ff48d52.jpg', '', '', '', 1, 1532679740, 'jpg', 1, '19580', '腿1.jpg');
INSERT INTO `yershop_attachment` VALUES (463, '/public/uploads/picture/20180727/e80a7e6cf64ccd672e48ea211949672f.jpg', '', '', '', 1, 1532679740, 'jpg', 1, '126923', '腿2.jpg');
INSERT INTO `yershop_attachment` VALUES (464, '/public/uploads/picture/20180727/8c4fe3fc92b9864c48edf6283a21fdfd.jpg', '', '', '', 1, 1532679865, 'jpg', 1, '25941', '牛肉卷.jpg');
INSERT INTO `yershop_attachment` VALUES (465, '/public/uploads/picture/20180727/b7329c831f16d8439dfa44e692c6b083.jpg', '', '', '', 1, 1532679903, 'jpg', 1, '77203', '肉卷1.jpg');
INSERT INTO `yershop_attachment` VALUES (466, '/public/uploads/picture/20180727/6996ff39f1a7cba3ed405434d0db9f15.jpg', '', '', '', 1, 1532679908, 'jpg', 1, '108919', '肉卷2.jpg');
INSERT INTO `yershop_attachment` VALUES (467, '/public/uploads/picture/20180727/c9c4c3779559f05d312ba13e34ec511c.jpg', '', '', '', 1, 1532680053, 'jpg', 1, '130809', '薄.jpg');
INSERT INTO `yershop_attachment` VALUES (468, '/public/uploads/picture/20180727/19cb33851bcaffae9e7e1508bdfce344.jpg', '', '', '', 1, 1532680095, 'jpg', 1, '150558', '薄1.jpg');
INSERT INTO `yershop_attachment` VALUES (469, '/public/uploads/picture/20180727/96e2ca88bf3097740ff2578ac5600963.jpg', '', '', '', 1, 1532680095, 'jpg', 1, '43849', '薄2.jpg');
INSERT INTO `yershop_attachment` VALUES (470, '/public/uploads/picture/20180727/ea1fa391e72f4dbf4e6779da3c290649.jpg', '', '', '', 1, 1532680302, 'jpg', 1, '156022', '火锅.jpg');
INSERT INTO `yershop_attachment` VALUES (471, '/public/uploads/picture/20180727/38b5c84e849895f54bba29f89674b94a.jpg', '', '', '', 1, 1532680324, 'jpg', 1, '72169', '火锅1.jpg');
INSERT INTO `yershop_attachment` VALUES (472, '/public/uploads/picture/20180727/71fc7d450eb5021c278a8b5bbeaf4b0f.jpg', '', '', '', 1, 1532680325, 'jpg', 1, '85120', '火锅2.jpg');
INSERT INTO `yershop_attachment` VALUES (473, '/public/uploads/picture/20180727/a54a718e0693bfe8c57aa6489d0e0365.jpg', '', '', '', 1, 1532681328, 'jpg', 1, '21581', '奶1.jpg');
INSERT INTO `yershop_attachment` VALUES (474, '/public/uploads/picture/20180727/05017d549aa548a2ce232b6c56a1fc56.jpg', '', '', '', 1, 1532681355, 'jpg', 1, '228260', '奶.jpg');
INSERT INTO `yershop_attachment` VALUES (475, '/public/uploads/picture/20180727/ee714815ab2c931054c7a8e63f489459.jpg', '', '', '', 1, 1532681355, 'jpg', 1, '22137', '奶2.jpg');
INSERT INTO `yershop_attachment` VALUES (476, '/public/uploads/picture/20180727/34340ae4706c15fa83e3ee627c96358b.jpg', '', '', '', 1, 1532681468, 'jpg', 1, '45202', '儿童.jpg');
INSERT INTO `yershop_attachment` VALUES (477, '/public/uploads/picture/20180727/51502b64e2b91bf5ba51e617e7a6b07b.jpg', '', '', '', 1, 1532681498, 'jpg', 1, '44983', '儿童1.jpg');
INSERT INTO `yershop_attachment` VALUES (478, '/public/uploads/picture/20180727/7ac42a340b0019bf1a43520f14dc6e99.jpg', '', '', '', 1, 1532681498, 'jpg', 1, '50816', '儿童2.jpg');
INSERT INTO `yershop_attachment` VALUES (479, '/public/uploads/picture/20180727/5e862d1261ca85d538118a94def49f86.jpg', '', '', '', 1, 1532681526, 'jpg', 1, '360959', '奶粉.jpg');
INSERT INTO `yershop_attachment` VALUES (480, '/public/uploads/picture/20180727/aa1a436e201bd52016d4c6add793b0fd.jpg', '', '', '', 1, 1532681554, 'jpg', 1, '31857', '奶粉1.jpg');
INSERT INTO `yershop_attachment` VALUES (481, '/public/uploads/picture/20180727/f036f8340cf469a917268c383fd6460b.jpg', '', '', '', 1, 1532681554, 'jpg', 1, '22322', '奶粉2.jpg');
INSERT INTO `yershop_attachment` VALUES (482, '/public/uploads/picture/20180727/ab425afdae73177cec42aec579fe7f9e.jpg', '', '', '', 1, 1532682027, 'jpg', 1, '86886', '粒.jpg');
INSERT INTO `yershop_attachment` VALUES (483, '/public/uploads/picture/20180727/d41c031cb2fea890d11324bdfae73db7.jpg', '', '', '', 1, 1532682056, 'jpg', 1, '114632', '粒1.jpg');
INSERT INTO `yershop_attachment` VALUES (484, '/public/uploads/picture/20180727/4d44c2a1dcaaf1209a5a8f82d06a9ab6.jpg', '', '', '', 1, 1532682056, 'jpg', 1, '18053', '粒2.jpg');
INSERT INTO `yershop_attachment` VALUES (485, '/public/uploads/picture/20180727/65bc75bbd97814087818e65a3d0f32f0.jpg', '', '', '', 1, 1532682073, 'jpg', 1, '57067', '干.jpg');
INSERT INTO `yershop_attachment` VALUES (486, '/public/uploads/picture/20180727/c60528d5ff41f2630d4b50a92a4aa5dd.jpg', '', '', '', 1, 1532682091, 'jpg', 1, '98306', '干1.jpg');
INSERT INTO `yershop_attachment` VALUES (487, '/public/uploads/picture/20180727/6980d1559872b4f62a7e2613accb8ab9.jpg', '', '', '', 1, 1532682091, 'jpg', 1, '82395', '干2.jpg');
...
CREATE TABLE `yershop_attributes`  (
  ...
  `value` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `is_show` int(2) NOT NULL DEFAULT 1,
  `short_title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 270 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_bonus`  (
  ...
  `status` tinyint(2) DEFAULT 1 COMMENT '数据状态',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `intro` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `total` decimal(50, 2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 10 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户红包表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_bonuses`  (
  ...
  `total` decimal(50, 2) NOT NULL DEFAULT 0.00,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 9 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '系统红包表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_brand`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标志',
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `price` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '金额',
  `code` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '关键字',
  `description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '描述',
  `meta_title` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  ...
  `category_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `goodid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE,
  UNIQUE INDEX `uk_name`(`name`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 27 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_cart`  (
  ...
  `price` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商品价格',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商品名称',
  `sku_id` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '库存序号',
  `specifications` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '商品参数',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `path` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `key` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `reduction_id` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 189 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '购物车表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_cart
-- ----------------------------
INSERT INTO `yershop_cart` VALUES (75, 227, 1, 209, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (74, 224, 1, 90, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (76, 207, 1, 89, '599.00', '', '320', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (77, 203, 1, 25, '12.00', '', '313', '&nbsp;1kg&nbsp;优惠套装1', 0, '80,83', NULL, 0);
INSERT INTO `yershop_cart` VALUES (78, 163, 1, 64, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (79, 223, 1, 79, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (80, 229, 1, 105, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (81, 231, 1, 67, '23.00', '', '379', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (82, 225, 1, 6, '1999.00', '', '355', '&nbsp;3G&nbsp;16G', 0, '75,87', NULL, 0);
INSERT INTO `yershop_cart` VALUES (83, 205, 1, 15, '2342.00', '', '318', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (84, 230, 3, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (85, 223, 3, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (86, 227, 3, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (87, 201, 3, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (88, 224, 3, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (89, 163, 3, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (90, 229, 3, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (91, 230, 4, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (92, 223, 4, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (93, 227, 4, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (94, 201, 4, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (95, 224, 4, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (96, 163, 4, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (97, 229, 4, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (98, 230, 5, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (99, 223, 5, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (100, 227, 5, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (101, 201, 5, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (102, 224, 5, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (103, 163, 5, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (104, 229, 5, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (105, 230, 6, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (106, 223, 6, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (107, 227, 6, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (108, 201, 6, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (109, 224, 6, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (110, 163, 6, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (111, 229, 6, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (112, 230, 7, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (113, 223, 7, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (114, 227, 7, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (115, 201, 7, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (116, 224, 7, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (117, 163, 7, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (118, 229, 7, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (119, 230, 8, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (120, 223, 8, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (121, 227, 8, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (122, 201, 8, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (123, 224, 8, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (124, 163, 8, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (125, 229, 8, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (126, 230, 9, 2, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (127, 223, 9, 1, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (128, 227, 9, 3, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (129, 201, 9, 1, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (130, 224, 9, 2, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (131, 163, 9, 1, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (132, 229, 9, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (133, 230, 1, 27, '11.00', '', '378', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (134, 201, 1, 41, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (135, 166, 1, 4, '30.00', '', '218', '&nbsp;', 0, '166', NULL, 0);
INSERT INTO `yershop_cart` VALUES (136, 193, 1, 10, '454.00', '', '300', '&nbsp;普装&nbsp;16开', 0, '113,116', NULL, 0);
INSERT INTO `yershop_cart` VALUES (137, 164, 1, 26, '20.00', '', '216', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (138, 207, 10, 5, '599.00', '', '320', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (139, 227, 10, 7, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (140, 223, 10, 3, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (141, 224, 10, 1, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (142, 168, 1, 5, '99.00', '', '220', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (143, 162, 1, 10, '0.10', '', '214', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (144, 167, 1, 7, '34.00', '', '219', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (145, 166, 1, 4, '30.00', '', '218', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (146, 169, 1, 8, '77.00', '', '221', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (147, 165, 1, 14, '8.90', '', '217', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (148, 227, 1, 2, '1212.00', '', '368', '&nbsp;黑&nbsp;官方标配&nbsp;2g', 0, '91,95,102', NULL, 0);
INSERT INTO `yershop_cart` VALUES (149, 177, 1, 3, '456.00', '', '260', '&nbsp;黑&nbsp;官方标配', 0, '91,95', NULL, 0);
INSERT INTO `yershop_cart` VALUES (150, 179, 1, 4, '5465.00', '', '273', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (151, 233, 1, 5, '6767.00', '', '381', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (152, 185, 1, 5, '124.00', '', '289', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (153, 191, 1, 1, '123.00', '', '298', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (154, 178, 1, 5, '39.90', '', '269', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (155, 170, 1, 2, '6456.00', '', '231', '&nbsp;3G&nbsp;16G', 0, '75,87', NULL, 0);
INSERT INTO `yershop_cart` VALUES (156, 171, 1, 1, '56765.00', '', '237', '&nbsp;4G&nbsp;16G', 0, '76,87', NULL, 0);
INSERT INTO `yershop_cart` VALUES (157, 190, 1, 5, '34.00', '', '297', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (158, 189, 1, 1, '234.00', '', '296', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (159, 209, 1, 1, '0.01', '', '322', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (160, 227, 11, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (161, 229, 11, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (162, 227, 12, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (163, 229, 12, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (164, 227, 13, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (165, 229, 13, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (166, 227, 14, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (167, 229, 14, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (168, 227, 15, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (169, 229, 15, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (170, 227, 16, 1, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (171, 229, 16, 1, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (172, 227, 17, 55, '101231.00', '', '367', '&nbsp;黑&nbsp;官方标配&nbsp;1g', 0, '91,95,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (173, 229, 17, 17, '23.00', '', '374', '&nbsp;红色&nbsp;x', 0, '63,66', NULL, 0);
INSERT INTO `yershop_cart` VALUES (174, 163, 17, 3, '24.00', '', '215', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (175, 162, 17, 1, '0.10', '', '214', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (176, 231, 17, 11, '23.00', '', '379', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (177, 224, 17, 6, '0.10', '', '354', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (178, 207, 17, 17, '599.00', '', '320', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (179, 169, 17, 3, '77.00', '', '221', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (180, 201, 17, 7, '34554.00', '', '311', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (181, 225, 17, 1, '1999.00', '', '355', '&nbsp;3G&nbsp;16G', 0, '75,87', NULL, 0);
INSERT INTO `yershop_cart` VALUES (182, 223, 17, 5, '100.00', '', '353', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (183, 232, 17, 1, '454.00', '', '380', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (184, 228, 17, 1, '44.00', '', '373', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (185, 227, 17, 1, '1231.00', '', '370', '&nbsp;黑&nbsp;套餐1&nbsp;1g', 0, '91,96,101', NULL, 0);
INSERT INTO `yershop_cart` VALUES (186, 205, 17, 2, '2342.00', '', '318', '&nbsp;', 0, '', NULL, 0);
INSERT INTO `yershop_cart` VALUES (187, 167, 17, 1, '34.00', '', '219', '&nbsp;', 0, '', NULL, 0);
...
CREATE TABLE `yershop_category`  (
  ...
  `display` tinyint(3) UNSIGNED NOT NULL DEFAULT 0 COMMENT '可见性',
  `extend` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '扩展设置',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
...
) ENGINE = MyISAM AUTO_INCREMENT = 200 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '分类表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_category
-- ----------------------------
INSERT INTO `yershop_category` VALUES (52, 'fruit', '牦牛制品', 0, 7, 10, '', '', '', '', '', '', 'goods/edit', '1', 1, '\"\"', 1411925214, 1489562378, 1, 209, 41);
INSERT INTO `yershop_category` VALUES (183, '', '牛肉卷', 181, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (71, 'tushu', '牦牛日常', 0, 4, 10, '', '', '', '', '', '', 'goods/edit', '1', 1, '', 1414344085, 1420956824, 1, 210, 46);
INSERT INTO `yershop_category` VALUES (81, 'ebook', '牦牛饲料', 71, 5, 10, '', '', '', '', '', '', '', '1', 1, '', 1420956858, 1420956858, 1, 0, 42);
INSERT INTO `yershop_category` VALUES (82, 'mianfei', '高粱', 81, 0, 10, '', '', '', '', '', '', '', '1', 1, '', 1420956901, 1420956901, 1, 0, 42);
INSERT INTO `yershop_category` VALUES (83, 'emusic', '玉米', 81, 0, 10, '', '', '', '', '', '', '', '1', 1, '', 1420959330, 1420960517, 1, 0, 46);
...
INSERT INTO `yershop_category` VALUES (122, 'dha', 'DHA', 121, 0, 10, '', '', '', '', '', '', '', '2', 1, '', 1420965492, 1420965492, 1, 0, 40);
...
INSERT INTO `yershop_category` VALUES (151, 'ylnn', '牛奶饮料', 52, 0, 30, '', '', '', '', '', '', '', '1', 1, '\"\"', 1442675533, 1442675533, 1, 427, 47);
...
INSERT INTO `yershop_category` VALUES (161, '', '牛肉粒', 152, 0, 0, '', '', '', '', '', '', '', '1', 1, '', 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (162, '', '麻辣牛肉干', 152, 0, 0, '', '', '', '', '', '', '', '1', 1, '', 0, 0, 1, 0, 40);
...
INSERT INTO `yershop_category` VALUES (171, '', '0点场', 165, 0, 0, '', '', '', '', '', '', '', '2', 0, '', 0, 0, 1, 0, 48);
INSERT INTO `yershop_category` VALUES (174, '', '通用', 165, 0, 0, '', '', '', '', '', '', 'goods/time', '1', 0, '', 0, 0, 1, 0, 48);
INSERT INTO `yershop_category` VALUES (175, '', '上衣', 115, 0, 0, '', '', '', '', '', '', 'goods/edit', '1', 0, '', 0, 0, 1, 0, 42);
INSERT INTO `yershop_category` VALUES (181, '', '生鲜牛肉', 0, 8, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (182, '', '高原牛肉', 181, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (184, '', '精瘦肉', 182, 2, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (185, '', '牛肚', 182, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (186, '', '牛腿骨', 182, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (187, '', '普通牛肉卷', 183, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (188, '', '特薄牛肉卷', 183, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (189, '', '火锅专用牛肉', 183, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (191, '', '原味牦牛奶', 151, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (192, '', '婴幼儿专供牛奶', 151, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (193, '', '大豆', 81, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (194, '', '牦牛医生', 71, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (195, '', '进口疫苗', 194, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (196, '', '预防疯牛病疫苗', 195, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (197, '', '日常消毒', 194, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (198, '', '腊牛肉', 182, 1, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
INSERT INTO `yershop_category` VALUES (199, '', '牦牛奶粉', 151, 0, 0, '', '', '', '', '', '', '', '1', 1, NULL, 0, 0, 1, 0, 40);
...
CREATE TABLE `yershop_change`  (
  ...
  `tool` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单号',
  `toolid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单号',
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `status` tinyint(2) NOT NULL DEFAULT 0,
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `info` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `total` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `backinfo` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `shopid` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `assistant` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `reason` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `changetool` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `changetoolid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `address` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `contact` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `parameters` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `backname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `acceptname` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `acceptphone` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `acceptaddress` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `username` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系人',
  `userphone` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系方式',
  `useraddress` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '联系地址',
  `partnerid` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_collect`  (
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 30 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '收藏表' ROW_FORMAT = Fixed;
...
CREATE TABLE `yershop_comment`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `score` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  ...
  `cover_id` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '图片',
  `status` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '1-可见 -1-无效',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 28 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '商品表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_config`  (
  ...
  `type` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '0' COMMENT '配置类型',
  `title` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '配置说明',
  `group` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '0' COMMENT '配置分组',
...
-- ----------------------------
INSERT INTO `yershop_config` VALUES (1, 'WEB_SITE_TITLE', 'text', '网站标题', '0', '', '网站标题前台显示标题', 1378898976, 1379235274, 1, '牦牛商城', 0);
...
INSERT INTO `yershop_config` VALUES (92, 'logo', 'picture', '网站logo', '0', '', '网站logo', 0, 0, 0, '448', 0);
INSERT INTO `yershop_config` VALUES (116, 'BTN', 'color', '按钮背景色', '1', '', '', 0, 0, 0, '#db2a2f', 0);
INSERT INTO `yershop_config` VALUES (91, 'GROUP', 'text', '配置分组', '-1', '', '', 0, 0, 0, '基本|高级|接口|参数|商城|支付|上传|邮箱', 0);
...
INSERT INTO `yershop_config` VALUES (126, 'REKEWORD', 'text', '热门搜索', '0', '', '', 0, 0, 0, '牦牛|牦牛肉|牛肉', 0);
...
CREATE TABLE `yershop_consult`  (
  ...
  `uid` int(10) NOT NULL DEFAULT 0,
  `reply` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `goods_id` int(10) NOT NULL DEFAULT 0,
  `is_hide` int(10) NOT NULL DEFAULT 0,
  `type` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 283 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_count`  (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户组id,自增主键',
  `mark` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '名称',
  `num` tinyint(11) NOT NULL DEFAULT 1 COMMENT '数量',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `type` tinyint(2) NOT NULL DEFAULT 0,
  `model` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
) ENGINE = MyISAM AUTO_INCREMENT = 92 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '文档模型基础表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_drawback`  (
  ...
  `express` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单号',
  `express_code` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单号',
  ...
  `info` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `money` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `description` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `address` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `specifications` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `cover_id` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `reason` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `style` tinyint(2) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 12 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '退货表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_email`  (
  ...
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标题',
  `api_user` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '邮箱',
  `content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '回复内容',
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id',
  `status` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '1已发送 -1禁用',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `group` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分组',
  `to` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `hash` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '发送邮件记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_envelope`  (
  `id` int(10) NOT NULL AUTO_INCREMENT,
  `username` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户名',
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '用户id',
  `sendname` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发件人',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标题',
  ...
  `group` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分组',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '站内信表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_express`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `code` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `status` tinyint(2) DEFAULT 1 COMMENT '数据状态',
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 16 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '快递表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_goods`  (
  ...
  `attributes` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT '',
  `view` int(10) NOT NULL DEFAULT 0,
  `comments` int(10) NOT NULL DEFAULT 0,
  `baoyou` tinyint(2) NOT NULL DEFAULT 0,
  `has` tinyint(2) NOT NULL DEFAULT 1,
  `attrs` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `spress` int(10) DEFAULT 0,
  `collect` int(10) NOT NULL DEFAULT 0,
  `covers` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `specs` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
...
-- ----------------------------
INSERT INTO `yershop_goods` VALUES (235, '精瘦牦牛肉', 1532678528, 0, 99, 1, '源自青藏高原牦牛肉，新鲜直达。', 184, 0, 452, 58.00, 0, 0.00, 0.00, NULL, 3, 0, 1, 1, NULL, 0, 0, '453,454', NULL, 1532678528, 18, 1532678528, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (236, '腊牛肉', 1532679092, 0, 56, 1, '腊牛肉', 198, 0, 455, 79.90, 0, 0.00, 0.00, NULL, 2, 0, 1, 1, NULL, 0, 0, '456,457', NULL, 1532679092, 18, 1532679092, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (237, '牛肚', 1532679537, 0, 88, 1, '牛肚', 185, 0, 458, 68.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '459,460', NULL, 1532679537, 18, 1532679537, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (238, '牛腿骨', 1532679725, 0, 10, 1, '牛腿骨', 186, 0, 461, 34.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '462,463', NULL, 1532679725, 18, 1532679725, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (239, '普通牛肉卷', 1532679874, 0, 78, 1, '', 187, 0, 464, 39.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '465,466', NULL, 1532679874, 18, 1532679874, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (240, '特薄牛肉卷', 1532680080, 0, 999, 1, '', 188, 0, 467, 48.00, 0, 0.00, 0.00, NULL, 1, 0, 1, 1, NULL, 0, 0, '468,469', NULL, 1532680080, 18, 1532680080, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (241, '火锅专用牛肉', 1532680310, 0, 99, 1, '', 189, 0, 470, 45.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '471,472', NULL, 1532680310, 18, 1532680310, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (242, '原味牦牛奶', 1532681356, 0, 9999, 1, '', 191, 0, 473, 6.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '474,475', NULL, 1532681356, 18, 1532681356, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (243, '婴幼儿专供牛奶', 1532681499, 0, 887, 1, '', 192, 0, 476, 12.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '477,478', NULL, 1532681499, 18, 1532681499, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (244, '牦牛奶粉', 1532681556, 0, 96, 1, '', 199, 0, 479, 420.00, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '480,481', NULL, 1532681556, 18, 1532681556, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (245, '牛肉粒', 1532682039, 0, 23, 1, '', 161, 0, 482, 49.90, 0, 0.00, 0.00, NULL, 0, 0, 1, 1, NULL, 0, 0, '483,484', NULL, 1532682039, 18, 1532682039, 0, 0, 0, 0);
INSERT INTO `yershop_goods` VALUES (246, '麻辣牛肉干', 1532682092, 0, 9, 1, '', 162, 0, 485, 68.00, 0, 0.00, 0.00, NULL, 1, 0, 1, 1, NULL, 0, 0, '486,487', NULL, 1532682092, 18, 1532682092, 0, 0, 0, 0);
...
CREATE TABLE `yershop_group`  (
  ...
  `module` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `icon` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE,
  INDEX `pid`(`pid`) USING BTREE,
...
INSERT INTO `yershop_group` VALUES (20, '分类', 0, 1, 'category/index', 0, 1, NULL, NULL);
...
CREATE TABLE `yershop_key`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `token` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '标志',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `status` tinyint(2) DEFAULT 1 COMMENT '数据状态',
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT 'uid',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'key表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_keyword`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '标题',
  `uid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接',
  `remark` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '更新时间',
  `key` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `status` int(2) NOT NULL DEFAULT 1,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 34 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '搜索表' ROW_FORMAT = Dynamic;
...
INSERT INTO `yershop_menu` VALUES (80, '商品分类', 166, 0, 'Category/index', 0, '', '商品管理', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (86, '备份数据库', 68, 9, 'Database/index?type=export', 0, '', '数据备份', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (90, '还原数据库', 68, 8, 'Database/index?type=import', 0, '', '数据备份', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (177, ' 快递管理', 131, 9, 'Express/index', 0, '', '订单相关', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (178, '日志管理', 146, 6, 'UserLog/index', 0, '', '数据管理', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (140, '换货管理', 131, 4, 'Change/index', 0, '', '订单管理', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (183, '属性配置', 166, 0, 'Attributes/index', 0, '', '商品管理', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (179, '支付管理', 131, 8, 'Pay/index', 0, '', '订单相关', 0, 1);
...
INSERT INTO `yershop_menu` VALUES (175, '预约列表', 68, 7, 'Reserve/index', 0, '', '预约管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (180, '商家审核', 181, 0, 'Check/index', 0, '', '用户管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (181, '商家', 0, 12, 'Check/index', 0, '', '', 0, 1);
INSERT INTO `yershop_menu` VALUES (182, '后台菜单', 181, 0, 'SellerMenu/index', 0, '', '基本管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (184, '商品属性', 166, 1, 'GoodsAttributes/index', 0, '', '商品管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (185, '商品列表', 166, 2, 'Goods/index', 0, '', '商品管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (186, ' 商品类型', 166, 0, 'Types/index', 0, '', '商品管理', 0, 1);
INSERT INTO `yershop_menu` VALUES (187, '库存sku', 166, 3, 'Stock/index', 0, '', '商品管理', 0, 1);
...
CREATE TABLE `yershop_message`  (
  ...
  `goodid` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '标题',
  `content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '留言内容',
...
CREATE TABLE `yershop_models`  (
  ...
  `tags` varchar(226) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type` tinyint(2) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `yershop_module` VALUES (18, '商品类型', 40, 0, 'types/index', 20, '', 1);
...
CREATE TABLE `yershop_order`  (
  ...
  `order_sn` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `total_money` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  ...
  `total` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `express` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '是否默认地址',
  `address_id` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `shipway` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '送货方式',
  `invoice_header` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票抬头',
  `message` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '留言',
  `score` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `coupon` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `score_money` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `username` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `mobile` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `address` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `express_code` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `arrive_time` decimal(50, 2) DEFAULT 0.00,
  `isdao` int(10) NOT NULL DEFAULT 0,
  `saleslist` text CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `invoice_content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '发票内容',
  `invoice_type` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `is_invoice` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 51 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '订单表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_order
-- ----------------------------
INSERT INTO `yershop_order` VALUES (50, '20180727153267451018', 30.00, 1532674510, 0, 0, 18, 0.00, 0, 30.00, NULL, 0, NULL, NULL, NULL, 0, NULL, 0.00, NULL, NULL, NULL, NULL, 0.00, 0, '费列罗巧克力零食48粒 3*16条 休闲零食 香浓美味&nbsp;数量1单价30.00 小计30</br>', NULL, NULL, NULL, 0, 0, 0, 0, 0, 0, 0, 0.00, 0.00, 0.00);
...
CREATE TABLE `yershop_pay`  (
  `id` int(11) NOT NULL AUTO_INCREMENT,
  `out_trade_no` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `model` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `trade_no` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `trade_status` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `remark` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 318 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '在线支付表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_picture`  (
  ...
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '创建时间',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 370 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_records`  (
  ...
  `url` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `country` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '订单号',
  `time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `uid` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `info` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `province` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `isp` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `referer` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '访问来源',
  `status` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `page` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `partnerid` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 416 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = 'ip访问记录表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_reduction`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类ID',
  `goods` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '标志',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `cover_id` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '广告图片',
  `total` decimal(50, 2) NOT NULL DEFAULT 0.00,
  `total_money` decimal(50, 2) NOT NULL DEFAULT 0.00,
  ...
  `end_time` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 11 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '满减优惠' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_reply`  (
  ...
  `group` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '分组',
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '回复表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_sales`  (
  ...
  `path` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `comment_status` int(10) NOT NULL DEFAULT 0,
  `spress` varchar(255) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `status` tinyint(2) NOT NULL DEFAULT 0,
  `type` int(10) NOT NULL DEFAULT 0,
  `reduction_id` int(10) NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 237 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_sales
-- ----------------------------
INSERT INTO `yershop_sales` VALUES (236, 0, NULL, 18, '费列罗巧克力零食48粒 3*16条 休闲零食 香浓美味', '20180727153267451018', 166, 0, 30.00, 1, 30.00, 218, 0, NULL, 0, NULL, 0, 0, 0);
...
CREATE TABLE `yershop_score_log`  (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT 'id,自增主键',
  `score` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '积分值',
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  `type` tinyint(1) NOT NULL DEFAULT 0 COMMENT '1+,0-',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
...
CREATE TABLE `yershop_service`  (
  ...
  `assistant` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `reply` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 3 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '售后服务表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_sku`  (
  ...
  `path` varchar(64) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '',
  ...
  `upc` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `code` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
...
-- ----------------------------
INSERT INTO `yershop_sku` VALUES (220, '无', 168, 0, 99.00, 0, 0, 1, 0, '168', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (218, '无', 166, 0, 30.00, 0, 0, 1, 0, '166', NULL, 23, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (219, '无', 167, 0, 34.00, 0, 0, 1, 0, '167', NULL, 333, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (217, '无', 165, 0, 8.90, 0, 0, 1, 0, '165', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (216, '无', 164, 0, 20.00, 0, 0, 1, 0, '164', NULL, 122, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (215, '无', 163, 0, 24.00, 0, 0, 1, 0, '163', NULL, 666, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (214, '无', 162, 0, 0.10, 0, 0, 1, 0, '162', NULL, 100, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (221, '无', 169, 0, 77.00, 0, 0, 1, 0, '169', NULL, 77, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (233, '3G、64G', 170, 0, 7464.00, 0, 0, 1, 0, '75,89', NULL, 76, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (232, '3G、32G', 170, 0, 6479.00, 0, 0, 1, 0, '75,88', NULL, 47, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (231, '3G、16G', 170, 0, 6456.00, 0, 0, 1, 0, '75,87', NULL, 56, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (230, '2G、64G', 170, 0, 5654.00, 0, 0, 1, 0, '74,89', NULL, 34, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (229, '2G、32G', 170, 0, 5654.00, 0, 0, 1, 0, '74,88', NULL, 98, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (228, '2G、16G', 170, 0, 5488.00, 0, 0, 1, 0, '74,87', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (234, '2G、16G', 171, 0, 5675.00, 0, 0, 1, 0, '74,87', NULL, 5675, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (235, '2G、32G', 171, 0, 65567.00, 0, 0, 1, 0, '74,88', NULL, 5676, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (236, '2G、64G', 171, 0, 5467.00, 0, 0, 1, 0, '74,89', NULL, 56765, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (237, '4G、16G', 171, 0, 56765.00, 0, 0, 1, 0, '76,87', NULL, 5675, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (238, '4G、32G', 171, 0, 56765.00, 0, 0, 1, 0, '76,88', NULL, 56765, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (239, '4G、64G', 171, 0, 567657.00, 0, 0, 1, 0, '76,89', NULL, 56765, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (240, '2G、16G', 172, 0, 5460.00, 0, 0, 1, 0, '74,87', NULL, 50, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (241, '3G、16G', 172, 0, 4560.00, 0, 0, 1, 0, '75,87', NULL, 40, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (242, '4G、16G', 172, 0, 4560.00, 0, 0, 1, 0, '76,87', NULL, 50, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (243, '6G、16G', 172, 0, 5564.00, 0, 0, 1, 0, '77,87', NULL, 45, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (244, '4G、16G', 173, 0, 3056.00, 0, 0, 1, 0, '76,87', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (245, '4G、32G', 173, 0, 3453.00, 0, 0, 1, 0, '76,88', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (246, '4G、64G', 173, 0, 5475.00, 0, 0, 1, 0, '76,89', NULL, 4564, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (247, '2G、16G', 174, 0, 3455.00, 0, 0, 1, 0, '74,87', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (248, '2G、32G', 174, 0, 3454.00, 0, 0, 1, 0, '74,88', NULL, 34535, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (249, '2G、64G', 174, 0, 34543.00, 0, 0, 1, 0, '74,89', NULL, 3, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (250, '红色、x', 175, 0, 435.00, 0, 0, 1, 0, '63,66', NULL, 546, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (251, '红色、xl', 175, 0, 4564.00, 0, 0, 1, 0, '63,67', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (252, '红色、xxl', 175, 0, 4564.00, 0, 0, 1, 0, '63,68', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (253, '蓝色、x', 175, 0, 546.00, 0, 0, 1, 0, '64,66', NULL, 546, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (254, '蓝色、xl', 175, 0, 5465.00, 0, 0, 1, 0, '64,67', NULL, 546, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (255, '蓝色、xxl', 175, 0, 456.00, 0, 0, 1, 0, '64,68', NULL, 4565, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (256, '红色、xl', 176, 0, 567.00, 0, 0, 1, 0, '63,67', NULL, 678, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (257, '红色、xxl', 176, 0, 6576.00, 0, 0, 1, 0, '63,68', NULL, 7897, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (258, '白色、xl', 176, 0, 78987.00, 0, 0, 1, 0, '69,67', NULL, 789, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (259, '白色、xxl', 176, 0, 7897.00, 0, 0, 1, 0, '69,68', NULL, 7897, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (260, '黑、官方标配', 177, 0, 456.00, 0, 0, 1, 0, '91,95', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (261, '黑、套餐1', 177, 0, 456.00, 0, 0, 1, 0, '91,96', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (262, '黑、套餐2', 177, 0, 456.00, 0, 0, 1, 0, '91,97', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (263, '白、官方标配', 177, 0, 456.00, 0, 0, 1, 0, '92,95', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (264, '白、套餐1', 177, 0, 4565.00, 0, 0, 1, 0, '92,96', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (265, '白、套餐2', 177, 0, 45645.00, 0, 0, 1, 0, '92,97', NULL, 45654, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (266, '金、官方标配', 177, 0, 45654.00, 0, 0, 1, 0, '93,95', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (267, '金、套餐1', 177, 0, 45654.00, 0, 0, 1, 0, '93,96', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (268, '金、套餐2', 177, 0, 4564.00, 0, 0, 1, 0, '93,97', NULL, 4565, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (269, '无', 178, 0, 39.90, 0, 0, 1, 0, '178', NULL, 100, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (274, '黑、官方标配、2g', 179, 0, 3456.00, 0, 0, 1, 0, '91,95,102', NULL, 654, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (273, '黑、官方标配、1g', 179, 0, 5465.00, 0, 0, 1, 0, '91,95,101', NULL, 546, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (275, '黑、套餐1、1g', 179, 0, 5456.00, 0, 0, 1, 0, '91,96,101', NULL, 645, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (276, '黑、套餐1、2g', 179, 0, 4456.00, 0, 0, 1, 0, '91,96,102', NULL, 645, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (277, '白、官方标配、1g', 179, 0, 4456.00, 0, 0, 1, 0, '92,95,101', NULL, 645, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (278, '白、官方标配、2g', 179, 0, 6456.00, 0, 0, 1, 0, '92,95,102', NULL, 54, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (279, '白、套餐1、1g', 179, 0, 7456.00, 0, 0, 1, 0, '92,96,101', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (280, '白、套餐1、2g', 179, 0, 84564.00, 0, 0, 1, 0, '92,96,102', NULL, 456, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (281, '无', 180, 0, 34.00, 0, 0, 1, 0, '180', NULL, 122, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (282, '无', 181, 0, 223.00, 0, 0, 1, 0, '181', NULL, 23, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (283, '无', 182, 0, 233.00, 0, 0, 1, 0, '182', NULL, 123, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (284, '无', 183, 0, 234.00, 0, 0, 1, 0, '183', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (285, '蓝色、xl', 184, 0, 234.00, 0, 0, 1, 0, '64,66', NULL, 32, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (286, '蓝色、xxl', 184, 0, 342.00, 0, 0, 1, 0, '64,66', NULL, 23, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (287, '白色、xl', 184, 0, 234.00, 0, 0, 1, 0, '69,66', NULL, 324, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (288, '白色、xxl', 184, 0, 343.00, 0, 0, 1, 0, '69,66', NULL, 32324, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (289, '红色、x', 185, 0, 124.00, 0, 0, 1, 0, '63,66', NULL, 567, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (290, '红色、xl', 185, 0, 235.00, 0, 0, 1, 0, '63,67', NULL, 567, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (291, '蓝色、x', 185, 0, 534.00, 0, 0, 1, 0, '64,66', NULL, 675, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (292, '蓝色、xl', 185, 0, 765.00, 0, 0, 1, 0, '64,67', NULL, 567, 337, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (293, '无', 186, 0, 234.00, 0, 0, 1, 0, '186', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (294, '无', 187, 0, 234.00, 0, 0, 1, 0, '187', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (295, '无', 188, 0, 234.00, 0, 0, 1, 0, '188', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (296, '无', 189, 0, 234.00, 0, 0, 1, 0, '189', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (297, '无', 190, 0, 34.00, 0, 0, 1, 0, '190', NULL, 324, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (298, '无', 191, 0, 123.00, 0, 0, 1, 0, '191', NULL, 123, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (299, '无', 192, 0, 213.00, 0, 0, 1, 0, '192', NULL, 123, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (300, '普装、16开', 193, 0, 454.00, 0, 0, 1, 0, '113,116', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (301, '普装、32开', 193, 0, 345.00, 0, 0, 1, 0, '113,117', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (302, '精装、16开', 193, 0, 345.00, 0, 0, 1, 0, '114,116', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (303, '精装、32开', 193, 0, 345.00, 0, 0, 1, 0, '114,117', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (304, '无', 194, 0, 434.00, 0, 0, 1, 0, '194', NULL, 324, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (305, '无', 195, 0, 324.00, 0, 0, 1, 0, '195', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (306, '无', 196, 0, 324.00, 0, 0, 1, 0, '196', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (307, '无', 197, 0, 234.00, 0, 0, 1, 0, '197', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (308, '无', 198, 0, 345.00, 0, 0, 1, 0, '198', NULL, 435, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (309, '无', 199, 0, 3245.00, 0, 0, 1, 0, '199', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (310, '无', 200, 0, 234.00, 0, 0, 1, 0, '200', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (311, '无', 201, 0, 34554.00, 0, 0, 1, 0, '201', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (312, '无', 202, 0, 34554.00, 0, 0, 1, 0, '202', NULL, 345, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (313, '1kg、优惠套装1', 203, 0, 12.00, 0, 0, 1, 0, '80,83', NULL, 56765, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (314, '1kg、优惠套装2', 203, 0, 18.00, 0, 0, 1, 0, '80,84', NULL, 567, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (315, '2kg、优惠套装1', 203, 0, 20.00, 0, 0, 1, 0, '81,83', NULL, 567, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (316, '2kg、优惠套装2', 203, 0, 26.00, 0, 0, 1, 0, '81,84', NULL, 5675, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (317, '无', 204, 0, 7213.00, 0, 0, 1, 0, '204', NULL, 123, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (318, '无', 205, 0, 2342.00, 0, 0, 1, 0, '205', NULL, 23, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (319, '无', 206, 0, 234.00, 0, 0, 1, 0, '206', NULL, 23432, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (320, '无', 207, 0, 599.00, 0, 0, 1, 0, '207', NULL, 344, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (321, '无', 208, 0, 0.01, 0, 0, 1, 0, '208', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (322, '无', 209, 0, 0.01, 0, 0, 1, 0, '209', NULL, 234, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (334, '4G、16G', 170, 0, 0.00, 0, 0, 1, 0, '76,87', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (335, '4G、32G', 170, 0, 0.00, 0, 0, 1, 0, '76,88', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (336, '4G、64G', 170, 0, 0.00, 0, 0, 1, 0, '76,89', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (337, '6G、16G', 170, 0, 0.00, 0, 0, 1, 0, '77,87', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (338, '6G、32G', 170, 0, 0.00, 0, 0, 1, 0, '77,88', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (339, '6G、64G', 170, 0, 0.00, 0, 0, 1, 0, '77,89', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (340, '蓝色、x', 184, 0, 0.00, 0, 0, 1, 0, '64,66', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (341, '白色、x', 184, 0, 0.00, 0, 0, 1, 0, '69,66', NULL, 0, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (342, '无', 212, 0, 100.00, 0, 0, 1, 0, '212', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (343, '无', 213, 0, 66.00, 0, 0, 1, 0, '213', NULL, 20, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (344, '无', 214, 0, 30.00, 0, 0, 1, 0, '214', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (345, '无', 215, 0, 1200.00, 0, 0, 1, 0, '215', NULL, 60, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (346, '无', 216, 0, 120.00, 0, 0, 1, 0, '216', NULL, 66, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (347, '无', 217, 0, 100.00, 0, 0, 1, 0, '217', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (348, '无', 218, 0, 100.00, 0, 0, 1, 0, '218', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (349, '无', 219, 0, 6.00, 0, 0, 1, 0, '219', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (350, '无', 220, 0, 500.00, 0, 0, 1, 0, '220', NULL, 6, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (351, '无', 221, 0, 5600.00, 0, 0, 1, 0, '221', NULL, 1, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (352, '无', 222, 0, 20.00, 0, 0, 1, 0, '222', NULL, 1, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (353, '无', 223, 0, 100.00, 0, 0, 1, 0, '223', NULL, 100, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (354, '无', 224, 0, 0.10, 0, 0, 1, 0, '224', NULL, 11, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (355, '3G、16G', 225, 0, 1999.00, 0, 0, 1, 0, '75,87', NULL, 10213, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (356, '3G、32G', 225, 0, 3997.00, 0, 0, 1, 0, '75,88', NULL, 1012321, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (357, '6G、16G', 225, 0, 4999.00, 0, 0, 1, 0, '77,87', NULL, 101231, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (358, '6G、32G', 225, 0, 5254.00, 0, 0, 1, 0, '77,88', NULL, 1212321, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (373, '无', 228, 0, 44.00, 0, 0, 1, 0, '228', NULL, 44, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (372, '黑、套餐1、3g', 227, 0, 12321.00, 0, 0, 1, 0, '91,96,109', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (371, '黑、套餐1、2g', 227, 0, 1231.00, 0, 0, 1, 0, '91,96,102', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (370, '黑、套餐1、1g', 227, 0, 1231.00, 0, 0, 1, 0, '91,96,101', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (369, '黑、官方标配、3g', 227, 0, 1231.00, 0, 0, 1, 0, '91,95,109', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (368, '黑、官方标配、2g', 227, 0, 1212.00, 0, 0, 1, 0, '91,95,102', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (367, '黑、官方标配、1g', 227, 0, 101231.00, 0, 0, 1, 0, '91,95,101', NULL, 12, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (374, '红色、x', 229, 0, 23.00, 0, 0, 1, 0, '63,66', NULL, 22, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (375, '红色、xl', 229, 0, 24.00, 0, 0, 1, 0, '63,67', NULL, 22, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (376, '蓝色、x', 229, 0, 25.00, 0, 0, 1, 0, '64,66', NULL, 22, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (377, '蓝色、xl', 229, 0, 22.00, 0, 0, 1, 0, '64,67', NULL, 22, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (378, '无', 230, 0, 11.00, 0, 0, 1, 0, '230', NULL, 11, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (379, '无', 231, 0, 23.00, 0, 0, 1, 0, '231', NULL, 33, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (380, '无', 232, 0, 454.00, 0, 0, 1, 0, '232', NULL, 45, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (381, '无', 233, 0, 6767.00, 0, 0, 1, 0, '233', NULL, 6, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (382, '无', 234, 0, 36.00, 0, 0, 1, 0, '234', NULL, 99, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (383, '无', 235, 0, 58.00, 0, 0, 1, 0, '235', NULL, 99, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (384, '无', 236, 0, 79.90, 0, 0, 1, 0, '236', NULL, 56, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (385, '无', 237, 0, 68.00, 0, 0, 1, 0, '237', NULL, 88, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (386, '无', 238, 0, 34.00, 0, 0, 1, 0, '238', NULL, 10, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (387, '无', 239, 0, 39.00, 0, 0, 1, 0, '239', NULL, 78, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (388, '无', 240, 0, 48.00, 0, 0, 1, 0, '240', NULL, 999, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (389, '无', 241, 0, 45.00, 0, 0, 1, 0, '241', NULL, 99, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (390, '无', 242, 0, 6.00, 0, 0, 1, 0, '242', NULL, 9999, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (391, '无', 243, 0, 12.00, 0, 0, 1, 0, '243', NULL, 887, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (392, '无', 244, 0, 420.00, 0, 0, 1, 0, '244', NULL, 96, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (393, '无', 245, 0, 49.90, 0, 0, 1, 0, '245', NULL, 23, 0, 0, 0.00, 0.00, 0, NULL, NULL);
INSERT INTO `yershop_sku` VALUES (394, '无', 246, 0, 68.00, 0, 0, 1, 0, '246', NULL, 9, 0, 0, 0.00, 0.00, 0, NULL, NULL);
...
CREATE TABLE `yershop_slide`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '分类id',
  `title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '标题',
  `url` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT '' COMMENT '链接',
  ...
  PRIMARY KEY (`id`) USING BTREE,
  UNIQUE INDEX `id`(`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 18 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '幻灯片图片储存表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_slide
-- ----------------------------
INSERT INTO `yershop_slide` VALUES (16, 'linin', 'goods/lists?id=52', 0, 0, 0, 0, 1, 445, 0, 229);
INSERT INTO `yershop_slide` VALUES (17, '43534', 'goods/lists?id=52', 0, 0, 0, 0, 1, 444, 0, 232);
...
CREATE TABLE `yershop_sms`  (
  `id` int(10) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '主键',
  `mobile` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '手机号码',
  `content` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '短信内容',
  `extcode` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '扩展子号',
  `signtag` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '签名',
  `uid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '用户id',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0 COMMENT '发送时间',
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `tempid` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '模板编号',
  ...
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '短信记录表' ROW_FORMAT = Fixed;
...
CREATE TABLE `yershop_specs`  (
  ...
  `short_title` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 135 CHARACTER SET = latin1 COLLATE = latin1_swedish_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_third_login`  (
  ...
  `appid` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `create_time` int(10) NOT NULL DEFAULT 0,
  `figureurl` varchar(226) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 1 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '第三方登陆表' ROW_FORMAT = Dynamic;
...
CREATE TABLE `yershop_types`  (
  ...
  `tags` varchar(226) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `type` tinyint(2) NOT NULL DEFAULT 0,
  `template_add` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'goods/add',
  `template_edit` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'goods/edit',
  `template_detail` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'goods/goods_detail',
  `template_lists` varchar(225) CHARACTER SET latin1 COLLATE latin1_swedish_ci NOT NULL DEFAULT 'goods/goods_lists',
  PRIMARY KEY (`id`) USING BTREE
...
INSERT INTO `yershop_types` VALUES (49, '团购', 0, 1, NULL, 0, 'goods/tuan', 'goods/tuan', 'goods/tuan_detail', 'goods/tuan_lists');
...
CREATE TABLE `yershop_ucenter_member`  (
  ...
  `email` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL COMMENT '用户邮箱',
  ...
  `star` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `sex` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `province` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `city` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  `area` varchar(225) CHARACTER SET utf8 COLLATE utf8_general_ci DEFAULT NULL,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 19 CHARACTER SET = utf8 COLLATE = utf8_general_ci COMMENT = '用户表' ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_ucenter_member
-- ----------------------------
INSERT INTO `yershop_ucenter_member` VALUES (18, 'sunwei', '520f5e931f6224cde069e999284de74a', NULL, 0, 0, 0, 1532672961, 0, 0, 1, 1, 0.00, 0, 0, NULL, NULL, NULL, NULL, NULL);
...
CREATE TABLE `yershop_user_log`  (
  `id` mediumint(8) UNSIGNED NOT NULL AUTO_INCREMENT COMMENT '用户组id,自增主键',
  `title` text CHARACTER SET utf8 COLLATE utf8_general_ci COMMENT '名称',
  `uid` int(10) UNSIGNED NOT NULL COMMENT '用户id',
  `status` tinyint(1) NOT NULL DEFAULT 1 COMMENT '用户组状态：为1正常，为0禁用,2为已使用',
  `create_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  `update_time` int(10) UNSIGNED NOT NULL DEFAULT 0,
  PRIMARY KEY (`id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 410 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;

-- ----------------------------
-- Records of yershop_user_log
-- ----------------------------
INSERT INTO `yershop_user_log` VALUES (322, 'del_category', 18, 1, 1532598038, 1532598038);
INSERT INTO `yershop_user_log` VALUES (323, 'del_category', 18, 1, 1532598047, 1532598047);
INSERT INTO `yershop_user_log` VALUES (324, 'del_category', 18, 1, 1532598066, 1532598066);
INSERT INTO `yershop_user_log` VALUES (325, 'del_category', 18, 1, 1532598072, 1532598072);
INSERT INTO `yershop_user_log` VALUES (326, 'del_category', 18, 1, 1532598077, 1532598077);
INSERT INTO `yershop_user_log` VALUES (327, 'del_category', 18, 1, 1532598081, 1532598081);
INSERT INTO `yershop_user_log` VALUES (328, 'del_category', 18, 1, 1532598091, 1532598091);
INSERT INTO `yershop_user_log` VALUES (329, 'del_category', 18, 1, 1532598103, 1532598103);
INSERT INTO `yershop_user_log` VALUES (330, 'del_category', 18, 1, 1532598113, 1532598113);
INSERT INTO `yershop_user_log` VALUES (331, 'del_category', 18, 1, 1532598127, 1532598127);
INSERT INTO `yershop_user_log` VALUES (332, 'del_category', 18, 1, 1532598147, 1532598147);
INSERT INTO `yershop_user_log` VALUES (333, 'del_category', 18, 1, 1532598158, 1532598158);
INSERT INTO `yershop_user_log` VALUES (334, 'del_category', 18, 1, 1532598167, 1532598167);
INSERT INTO `yershop_user_log` VALUES (335, 'del_category', 18, 1, 1532598181, 1532598181);
INSERT INTO `yershop_user_log` VALUES (336, 'del_category', 18, 1, 1532598188, 1532598188);
INSERT INTO `yershop_user_log` VALUES (337, 'del_category', 18, 1, 1532598207, 1532598207);
INSERT INTO `yershop_user_log` VALUES (338, 'del_category', 18, 1, 1532598215, 1532598215);
INSERT INTO `yershop_user_log` VALUES (339, 'edit_category', 18, 1, 1532598244, 1532598244);
INSERT INTO `yershop_user_log` VALUES (340, 'edit_category', 18, 1, 1532598266, 1532598266);
INSERT INTO `yershop_user_log` VALUES (341, 'edit_category', 18, 1, 1532598299, 1532598299);
INSERT INTO `yershop_user_log` VALUES (342, 'edit_category', 18, 1, 1532598346, 1532598346);
INSERT INTO `yershop_user_log` VALUES (343, 'del_category', 18, 1, 1532598359, 1532598359);
INSERT INTO `yershop_user_log` VALUES (344, 'del_category', 18, 1, 1532598369, 1532598369);
INSERT INTO `yershop_user_log` VALUES (345, 'del_category', 18, 1, 1532598381, 1532598381);
INSERT INTO `yershop_user_log` VALUES (346, 'edit_category', 18, 1, 1532598432, 1532598432);
INSERT INTO `yershop_user_log` VALUES (347, 'edit_category', 18, 1, 1532598452, 1532598452);
INSERT INTO `yershop_user_log` VALUES (348, 'edit_category', 18, 1, 1532598498, 1532598498);
INSERT INTO `yershop_user_log` VALUES (349, 'edit_category', 18, 1, 1532598571, 1532598571);
INSERT INTO `yershop_user_log` VALUES (350, 'del_category', 18, 1, 1532598583, 1532598583);
INSERT INTO `yershop_user_log` VALUES (351, 'edit_category', 18, 1, 1532598615, 1532598615);
INSERT INTO `yershop_user_log` VALUES (352, 'edit_category', 18, 1, 1532598630, 1532598630);
INSERT INTO `yershop_user_log` VALUES (353, 'del_category', 18, 1, 1532598634, 1532598634);
INSERT INTO `yershop_user_log` VALUES (354, 'edit_slide', 18, 1, 1532599369, 1532599369);
INSERT INTO `yershop_user_log` VALUES (355, 'edit_slide', 18, 1, 1532599535, 1532599535);
INSERT INTO `yershop_user_log` VALUES (356, 'edit_config', 18, 1, 1532673103, 1532673103);
INSERT INTO `yershop_user_log` VALUES (357, 'edit_config', 18, 1, 1532673159, 1532673159);
INSERT INTO `yershop_user_log` VALUES (358, 'edit_config', 18, 1, 1532673168, 1532673168);
INSERT INTO `yershop_user_log` VALUES (359, 'edit_config', 18, 1, 1532673176, 1532673176);
INSERT INTO `yershop_user_log` VALUES (360, 'edit_config', 18, 1, 1532673489, 1532673489);
INSERT INTO `yershop_user_log` VALUES (361, 'edit_config', 18, 1, 1532673498, 1532673498);
INSERT INTO `yershop_user_log` VALUES (362, 'edit_config', 18, 1, 1532673536, 1532673536);
INSERT INTO `yershop_user_log` VALUES (363, 'edit_config', 18, 1, 1532674588, 1532674588);
INSERT INTO `yershop_user_log` VALUES (364, 'edit_category', 18, 1, 1532674662, 1532674662);
INSERT INTO `yershop_user_log` VALUES (365, 'del_category', 18, 1, 1532674727, 1532674727);
INSERT INTO `yershop_user_log` VALUES (366, 'edit_category', 18, 1, 1532674746, 1532674746);
INSERT INTO `yershop_user_log` VALUES (367, 'edit_category', 18, 1, 1532674983, 1532674983);
INSERT INTO `yershop_user_log` VALUES (368, 'edit_category', 18, 1, 1532674997, 1532674997);
INSERT INTO `yershop_user_log` VALUES (369, 'add_category', 18, 1, 1532675739, 1532675739);
INSERT INTO `yershop_user_log` VALUES (370, 'edit_category', 18, 1, 1532675767, 1532675767);
INSERT INTO `yershop_user_log` VALUES (371, 'edit_category', 18, 1, 1532675799, 1532675799);
INSERT INTO `yershop_user_log` VALUES (372, 'add_category', 18, 1, 1532675845, 1532675845);
INSERT INTO `yershop_user_log` VALUES (373, 'del_category', 18, 1, 1532675891, 1532675891);
INSERT INTO `yershop_user_log` VALUES (374, 'edit_category', 18, 1, 1532675901, 1532675901);
INSERT INTO `yershop_user_log` VALUES (375, 'edit_category', 18, 1, 1532675965, 1532675965);
INSERT INTO `yershop_user_log` VALUES (376, 'edit_category', 18, 1, 1532675985, 1532675985);
INSERT INTO `yershop_user_log` VALUES (377, 'add_category', 18, 1, 1532675996, 1532675996);
INSERT INTO `yershop_user_log` VALUES (378, 'add_category', 18, 1, 1532676056, 1532676056);
INSERT INTO `yershop_user_log` VALUES (379, 'add_category', 18, 1, 1532676067, 1532676067);
INSERT INTO `yershop_user_log` VALUES (380, 'add_category', 18, 1, 1532676076, 1532676076);
INSERT INTO `yershop_user_log` VALUES (381, 'add_category', 18, 1, 1532676108, 1532676108);
INSERT INTO `yershop_user_log` VALUES (382, 'add_category', 18, 1, 1532676120, 1532676120);
INSERT INTO `yershop_user_log` VALUES (383, 'add_category', 18, 1, 1532676136, 1532676136);
INSERT INTO `yershop_user_log` VALUES (384, 'edit_category', 18, 1, 1532676327, 1532676327);
INSERT INTO `yershop_user_log` VALUES (385, 'add_category', 18, 1, 1532676348, 1532676348);
INSERT INTO `yershop_user_log` VALUES (386, 'add_category', 18, 1, 1532676370, 1532676370);
INSERT INTO `yershop_user_log` VALUES (387, 'add_category', 18, 1, 1532676390, 1532676390);
INSERT INTO `yershop_user_log` VALUES (388, 'edit_category', 18, 1, 1532676431, 1532676431);
INSERT INTO `yershop_user_log` VALUES (389, 'edit_category', 18, 1, 1532676518, 1532676518);
INSERT INTO `yershop_user_log` VALUES (390, 'edit_category', 18, 1, 1532676531, 1532676531);
INSERT INTO `yershop_user_log` VALUES (391, 'edit_category', 18, 1, 1532676540, 1532676540);
INSERT INTO `yershop_user_log` VALUES (392, 'add_category', 18, 1, 1532676549, 1532676549);
INSERT INTO `yershop_user_log` VALUES (393, 'add_category', 18, 1, 1532676573, 1532676573);
INSERT INTO `yershop_user_log` VALUES (394, 'add_category', 18, 1, 1532676585, 1532676585);
INSERT INTO `yershop_user_log` VALUES (395, 'add_category', 18, 1, 1532676602, 1532676602);
INSERT INTO `yershop_user_log` VALUES (396, 'edit_category', 18, 1, 1532676632, 1532676632);
INSERT INTO `yershop_user_log` VALUES (397, 'add_category', 18, 1, 1532676655, 1532676655);
INSERT INTO `yershop_user_log` VALUES (398, 'add_category', 18, 1, 1532678331, 1532678331);
INSERT INTO `yershop_user_log` VALUES (399, 'edit_category', 18, 1, 1532678346, 1532678346);
INSERT INTO `yershop_user_log` VALUES (400, 'edit_category', 18, 1, 1532678366, 1532678366);
INSERT INTO `yershop_user_log` VALUES (401, 'edit_category', 18, 1, 1532678382, 1532678382);
INSERT INTO `yershop_user_log` VALUES (402, 'edit_category', 18, 1, 1532680203, 1532680203);
INSERT INTO `yershop_user_log` VALUES (403, 'edit_category', 18, 1, 1532680540, 1532680540);
INSERT INTO `yershop_user_log` VALUES (404, 'edit_category', 18, 1, 1532680564, 1532680564);
INSERT INTO `yershop_user_log` VALUES (405, 'add_category', 18, 1, 1532680627, 1532680627);
INSERT INTO `yershop_user_log` VALUES (406, 'edit_category', 18, 1, 1532681186, 1532681186);
INSERT INTO `yershop_user_log` VALUES (407, 'edit_category', 18, 1, 1532681431, 1532681431);
INSERT INTO `yershop_user_log` VALUES (408, 'del_category', 18, 1, 1532681855, 1532681855);
INSERT INTO `yershop_user_log` VALUES (409, 'edit_category', 18, 1, 1532681895, 1532681895);
